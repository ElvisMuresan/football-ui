...
import { getPlayerById, getPlayers } from './api/football-api'
...
export const App = () => {
  ...
  return (
    <div className="container p-11">
      ...
      <PlayerTable onPlayerClick={handlePLayerClick} players={players} />
      ...
      <div className="mb-4 p-6 shadow-lg border border-gray-200 max-w-3xl mx-auto flex items-center space-x-8">
        ...
        <button className="p-2 bg-blue-500 text-white" onClick={handleFilter}>
          Filter
        </button>
      </div>
